...
function render(type,repaint=true,start=0) {
    $.ajax({
        url:"https://api.jisuapi.com/news/get?channel="+type+"&start="+start+"&num=10&appkey=928182a1a53ac025",
        dataType:'jsonp',
...
//获取新闻频道
$.ajax({
    url:'https://api.jisuapi.com/news/channel?appkey=928182a1a53ac025',
    dataType:'jsonp',
    success:function (res) {
        let arr = res.result;
        let str = "";
